...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Livros após ordenação natural (Título): ");
        ...
        for(Livro livro: livros){
            System.out.printf("\n%d - %s - %s\n", livro.getAno(), livro.getTitulo(), livro.getAutor());
        }
        ...
        for(Livro livro: livros){
            System.out.printf("\n%s - %s - %d\n", livro.getAutor(), livro.getTitulo(), livro.getAno());
        }
        ...
        for(Livro livro: livros){
            System.out.printf("\n%d - %s - %s\n", livro.getAno(), livro.getAutor(), livro.getTitulo());
        }
